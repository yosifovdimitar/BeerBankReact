    ...
    render() {
        return (
            <div className="bb-item-element">
                <div  onClick={this.favoriteButtonClicked} className="bb-element-favorite-button">
                    <svg ref={this.favIconRef} className="bb-svg-star" width="210mm" height="297mm" version="1.1" viewBox="0 0 210 297" xmlns="http://www.w3.org/2000/svg">
